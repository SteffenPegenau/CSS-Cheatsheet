...
;
  ...
  ++(7.5cm,0) node[anchor=north west,text width=9cm,rounded corners,fill=gray!15,inner sep=1ex,drop shadow]
  (zweite-spalte)
  {
    \platz
  ...
  ++(0,-3.5cm) node[below right,text width=9cm,rounded corners,fill=gray!15,inner sep=1ex,drop shadow]
  {
    \platz
  ...
  ++(0,-2.7cm) node[below right,text width=9cm,rounded corners,fill=gray!15,inner sep=1ex,drop shadow]
  {
    \platz
